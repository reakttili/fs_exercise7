...
export class App extends React.Component {
  ...
  componentDidMount() {
    console.log('componentDidMount!w')
            ...
            <Grid>
             <Grid.Row>
                <Grid.Column>
                  ...
                  <Button id="logoutbtn" floated= {"right"} name='logoutbtn' size={"mini"} onClick={this.handleLogout}>logout</Button>
